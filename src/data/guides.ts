...
export const guides: GuideMeta[] = [
  ...
  {
    slug: 'ford-key-replacement-london',
    title: 'Ford Key Replacement in London: Costs, Models & On-Site Programming',
    excerpt: 'On-site Ford key cutting and programming across London for Fiesta, Focus, Puma, Kuga, Mondeo, Transit, Ranger, Mustang and Mach-E. Fixed-price, no main dealer.',
    category: 'Auto',
    readTime: '7 min read',
    icon: 'fa-car',
  },
